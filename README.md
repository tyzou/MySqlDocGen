...
这是一个简单易用的 Python 桌面应用程序，旨在帮助开发者快速将 MySQL 数据库的表结构信息导出为格式化的 Microsoft Word (`.docx`) 文档。
...
- **文档美观**：导出的 Word 文档包含清晰的表格，涵盖字段名、类型、长度、是否为空、默认值及注释。
...
3. **选择数据表**：
   ...
   - 或者点击“全选”。
4. **生成文档**：点击“生成 Word 文档”，选择保存路径，等待完成后即可查看。
...
<img src="images/image-20260205222843155.png" alt="image-20260205222843155" style="zoom:50%;" /> 





<img src="images/image-20260205222914286.png" alt="image-20260205222914286" style="zoom:50%;" /> 
